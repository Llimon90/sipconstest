...
// Función para obtener y mostrar clientes con filtro opcional
async function cargarClientes(filtro = '') {
  try {
    const url = filtro 
      ? `../backend/buscar-clientes.php?q=${encodeURIComponent(filtro)}`
      : '../backend/obtener-clientes.php';
...
// Resto de tus funciones existentes (confirmarEliminacion, eliminarCliente, cargarFormularioEdicion, actualizarCliente)...

// Cargar clientes y configurar búsqueda al cargar la página
